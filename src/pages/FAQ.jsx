...
const faqs = [
  {
    ...
    answer:
      "Microfinance refers to the provision of financial services to low-income individuals or communities who typically lack access to traditional banking services. It includes microloans, savings accounts, insurance, and other financial products tailored to meet the needs of underserved populations.",
  },
  {
    question: "How does microfinance help communities?",
    answer:
      "Microfinance plays a crucial role in empowering communities by providing them with access to financial resources. It enables individuals to start or expand small businesses, improve their livelihoods, and contribute to economic growth. Additionally, microfinance promotes financial inclusion by integrating marginalized groups into the formal financial system.",
  },
  {
    question: "What types of microfinance services does AD Finance offer?",
    answer:
      "AD Finance offers a range of microfinance services including microloans, group lending, savings accounts, insurance products, and financial literacy training. These services are designed to meet the unique needs of microentrepreneurs and individuals from low-income communities, fostering economic empowerment and sustainable development.",
  },
  {
  ...
  {
    question:
      "What are the benefits of partnering with AD Finance for microfinance initiatives?",
    answer:
      "Partnering with AD Finance for microfinance initiatives offers several benefits, including access to tailored financial solutions, expertise in microfinance operations, collaborative opportunities for social impact, and support from a reputable financial institution committed to responsible business practices. Together, we can empower communities, drive sustainable development, and create lasting positive change.",
  },
];
